...
def process_single_file(
    laz_file, output_file, color_by="height", colormap="rainbow", subsample=None
):
...
def laz_to_obj(
    input_path, output_path, color_by="height", colormap="rainbow", subsample=None
):
    """
    ...
    if input_path.is_file():
        ...
        return process_single_file(
            input_path, output_path, color_by, colormap, subsample
        )
